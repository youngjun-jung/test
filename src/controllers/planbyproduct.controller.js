...
const executeProcedure = require('../procedures/planbyproduct.procedure');
const logger = require('../../logger'); 

  // 비즈니스 로직
exports.getPlanbyproductchk = async (req, res) => {
  ...
  query = `SELECT X.YEAR, X.MNAME, X.SNAME
          ...
          FROM PLANNING_BY_PRODUCT_CODE X, PLANNING_BY_PRODUCT A
