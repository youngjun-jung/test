...
exports.postProcnew1chk = async (req, res) => { 
  try {
    ...
    // 저장 프로시저 호출
    const data = await executeProcedure.callProcnewproc(year, procid, zin_in, zin_lo, zin_out, zin_out_in, s_in, s_dong, s_on, scode, zinc_trans, ca_trans, comments, labor);
