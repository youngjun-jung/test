...
const executeProcedure = require('../procedures/submaterialaia.procedure');
const logger = require('../../logger'); 

  // 비즈니스 로직
exports.getSubmaterialaiachk = async (req, res) => {
  ...
  // 프로시저 호출
  const data1 = await executeProcedure.callSubmaterialaiaproc(year);
