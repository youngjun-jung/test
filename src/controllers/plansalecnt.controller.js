...
exports.getPlansalecntchk = async (req, res) => {
  ...
  const query = `SELECT A.YEAR, A.NAME, A.LNAME, A.MNAME, A.SNAME, A.SCODE
                , ROUND(MONTH_01, 2) MONTH_01, ROUND(MONTH_02, 2) MONTH_02, ROUND(MONTH_03, 2) MONTH_03
                , ROUND(MONTH_04, 2) MONTH_04, ROUND(MONTH_05, 2) MONTH_05, ROUND(MONTH_06, 2) MONTH_06
                , ROUND(MONTH_07, 2) MONTH_07, ROUND(MONTH_08, 2) MONTH_08, ROUND(MONTH_09, 2) MONTH_09
                , ROUND(MONTH_10, 2) MONTH_10, ROUND(MONTH_11, 2) MONTH_11, ROUND(MONTH_12, 2) MONTH_12
