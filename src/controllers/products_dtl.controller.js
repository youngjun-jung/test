  ...
  if (month == '00') {
    query = `SELECT YEAR, NAME, LNAME, MNAME, SNAME, MEASURE
                  ...
                  FROM (
                      ...
                      + A.MONTH_07 + A.MONTH_08 + A.MONTH_09 + A.MONTH_10 + A.MONTH_11 + A.MONTH_12 AS MONTH_00, X.IDX 
