...
const executeProcedure = require('../procedures/planproc.procedure');
const logger = require('../../logger'); 

// 비즈니스 로직
exports.postPlanprocchk = async (req, res) => { 
  try {
    // 요청 본문에서 JSON 데이터 추출
    ...
    // 저장 프로시저 호출
    const data = await executeProcedure.callPlanprocproc(year, procid);
