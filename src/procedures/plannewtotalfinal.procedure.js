...
// 프로시저 호출 함수
exports.callPlannewtotalfinalproc = async (year, pd_1, pd_2, pd_3, pd_4, pd_5, pd_6, pd_7, pd_8, pd_9, pd_10, pd_11, pd_12) => {
    let connection;
    try {
        ...
        const result = await connection.execute(
            `BEGIN 
                SP_PLAN_NEW_TOTAL_FINAL_PROC(:year, :pd_1, :pd_2, :pd_3, :pd_4, :pd_5, :pd_6, :pd_7, :pd_8, :pd_9, :pd_10, :pd_11, :pd_12, :returncode); 
            END;`,
            {
                year: year, // 매개변수
                pd_1: pd_1, // 매개변수
